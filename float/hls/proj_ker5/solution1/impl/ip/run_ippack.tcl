...
set IPName      "conv2d"
set Version     "1.0"
set DisplayName "Conv2d"
set Revision    "2105011611"
...
set xo_kernel_name "conv2d"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "D:/IITMadrasICS/1-2/EE5332Project/float/proj_float5/solution1"
set debug_dir "D:/IITMadrasICS/1-2/EE5332Project/float/proj_float5/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {conv2d_fadd_32ns_32ns_32_5_full_dsp_1
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 RESERVED_3 R 0 "Reserved.  0s on read." } { 10 22 RESERVED_4 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 kernel_in_0_0 W 0x0 "Data signal of kernel_in_0_0" {{0 32 kernel_in_0_0 W 0 "Bit 31 to 0 of kernel_in_0_0"}}} {0x18 kernel_in_0_1 W 0x0 "Data signal of kernel_in_0_1" {{0 32 kernel_in_0_1 W 0 "Bit 31 to 0 of kernel_in_0_1"}}} {0x20 kernel_in_0_2 W 0x0 "Data signal of kernel_in_0_2" {{0 32 kernel_in_0_2 W 0 "Bit 31 to 0 of kernel_in_0_2"}}} {0x28 kernel_in_0_3 W 0x0 "Data signal of kernel_in_0_3" {{0 32 kernel_in_0_3 W 0 "Bit 31 to 0 of kernel_in_0_3"}}} {0x30 kernel_in_0_4 W 0x0 "Data signal of kernel_in_0_4" {{0 32 kernel_in_0_4 W 0 "Bit 31 to 0 of kernel_in_0_4"}}} {0x38 kernel_in_1_0 W 0x0 "Data signal of kernel_in_1_0" {{0 32 kernel_in_1_0 W 0 "Bit 31 to 0 of kernel_in_1_0"}}} {0x40 kernel_in_1_1 W 0x0 "Data signal of kernel_in_1_1" {{0 32 kernel_in_1_1 W 0 "Bit 31 to 0 of kernel_in_1_1"}}} {0x48 kernel_in_1_2 W 0x0 "Data signal of kernel_in_1_2" {{0 32 kernel_in_1_2 W 0 "Bit 31 to 0 of kernel_in_1_2"}}} {0x50 kernel_in_1_3 W 0x0 "Data signal of kernel_in_1_3" {{0 32 kernel_in_1_3 W 0 "Bit 31 to 0 of kernel_in_1_3"}}} {0x58 kernel_in_1_4 W 0x0 "Data signal of kernel_in_1_4" {{0 32 kernel_in_1_4 W 0 "Bit 31 to 0 of kernel_in_1_4"}}} {0x60 kernel_in_2_0 W 0x0 "Data signal of kernel_in_2_0" {{0 32 kernel_in_2_0 W 0 "Bit 31 to 0 of kernel_in_2_0"}}} {0x68 kernel_in_2_1 W 0x0 "Data signal of kernel_in_2_1" {{0 32 kernel_in_2_1 W 0 "Bit 31 to 0 of kernel_in_2_1"}}} {0x70 kernel_in_2_2 W 0x0 "Data signal of kernel_in_2_2" {{0 32 kernel_in_2_2 W 0 "Bit 31 to 0 of kernel_in_2_2"}}} {0x78 kernel_in_2_3 W 0x0 "Data signal of kernel_in_2_3" {{0 32 kernel_in_2_3 W 0 "Bit 31 to 0 of kernel_in_2_3"}}} {0x80 kernel_in_2_4 W 0x0 "Data signal of kernel_in_2_4" {{0 32 kernel_in_2_4 W 0 "Bit 31 to 0 of kernel_in_2_4"}}} {0x88 kernel_in_3_0 W 0x0 "Data signal of kernel_in_3_0" {{0 32 kernel_in_3_0 W 0 "Bit 31 to 0 of kernel_in_3_0"}}} {0x90 kernel_in_3_1 W 0x0 "Data signal of kernel_in_3_1" {{0 32 kernel_in_3_1 W 0 "Bit 31 to 0 of kernel_in_3_1"}}} {0x98 kernel_in_3_2 W 0x0 "Data signal of kernel_in_3_2" {{0 32 kernel_in_3_2 W 0 "Bit 31 to 0 of kernel_in_3_2"}}} {0xa0 kernel_in_3_3 W 0x0 "Data signal of kernel_in_3_3" {{0 32 kernel_in_3_3 W 0 "Bit 31 to 0 of kernel_in_3_3"}}} {0xa8 kernel_in_3_4 W 0x0 "Data signal of kernel_in_3_4" {{0 32 kernel_in_3_4 W 0 "Bit 31 to 0 of kernel_in_3_4"}}} {0xb0 kernel_in_4_0 W 0x0 "Data signal of kernel_in_4_0" {{0 32 kernel_in_4_0 W 0 "Bit 31 to 0 of kernel_in_4_0"}}} {0xb8 kernel_in_4_1 W 0x0 "Data signal of kernel_in_4_1" {{0 32 kernel_in_4_1 W 0 "Bit 31 to 0 of kernel_in_4_1"}}} {0xc0 kernel_in_4_2 W 0x0 "Data signal of kernel_in_4_2" {{0 32 kernel_in_4_2 W 0 "Bit 31 to 0 of kernel_in_4_2"}}} {0xc8 kernel_in_4_3 W 0x0 "Data signal of kernel_in_4_3" {{0 32 kernel_in_4_3 W 0 "Bit 31 to 0 of kernel_in_4_3"}}} {0xd0 kernel_in_4_4 W 0x0 "Data signal of kernel_in_4_4" {{0 32 kernel_in_4_4 W 0 "Bit 31 to 0 of kernel_in_4_4"}}} {0xd8 img_size W 0x0 "Data signal of img_size" {{0 32 img_size W 0 "Bit 31 to 0 of img_size"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
